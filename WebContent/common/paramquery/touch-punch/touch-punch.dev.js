...
(function ($) {
   ...
   * @param {Boolean} whether to prevent default action of the event.
   */
  ...
  mouseProto._touchStart = function (event) {
    ...
    // or touch is on cancelable elements e.g., textbox, textarea, etc.
    ...
    if (touchHandled || isCancel || !self._mouseCapture(touch)) {
      return;
    }
  ...
  mouseProto._touchEnd = function (event) {
    ...
    if (!this._touchMoved) {
      ...
      // let default click event of touch device take place.
