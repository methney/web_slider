...
(function($) {
	...
	_pGenerateView._generateTitleRow = function(GM, rowObj, buffer, lastFrozenRow) {
		...
		buffer.push(["<tr class='pq-group-row pq-grid-row", (lastFrozenRow ? " pq-last-freeze-row" : ""), "' title=\"", rowObj.groupTitle, "\" id=\"pq_group_", rowObj.groupTitle, "\" level='", groupLevel, "' GMRowIndx='", GMRowIndx, "'>"].join(""));
		if (numberCell.show) {
